...
class VIterationTest(unittest.TestCase):
    ...
    def test_convergence(self):
        ...
        for dif in q_dif.flat:
            self.assertTrue(-rtol < dif < rtol, "QIteration: q-function is outside the tolerance")
        v_dif = v_set - v_is
        ...
        for dif in v_dif.flat:
            self.assertTrue(-rtol < dif < rtol, "QIteration: v-function is outside the tolerance")
